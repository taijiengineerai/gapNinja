...
(function () {
  ...
  const STEPS = [
    ...
    },
    {
      ...
      title: "My Profile",
      body: "Your skills, experience, and job search preferences live here — you can also fetch live job listings that match you, and pick an accent color and light/dark mode under Appearance.",
    },
    {
