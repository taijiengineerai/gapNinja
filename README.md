...
- **Cover Letters** — a browsable library of every cover letter gapNinja has drafted for a saved application (searchable by company or role), so an old one is easy to find and reuse — view the full text, **Copy** it, or **Download PDF**. Read-only: editing a letter still happens on its original application in the Dashboard.
